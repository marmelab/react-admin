...
* Bump `terser` from 5.10.0 to 5.15.1 ([#8323](https://github.com/marmelab/react-admin/pull/8323)) ([dependabot bot](https://github.com/dependabot bot))
* Bump `ansi-regex` from 4.1.0 to 4.1.1 ([#8321](https://github.com/marmelab/react-admin/pull/8321)) ([dependabot bot](https://github.com/dependabot bot))
