...
* Fix `useReferenceArrayInputController` sets `loading` prop incorrecly ([#6914](https://github.com/marmelab/react-admin/pull/6914)) ([WiXSL](https://github.com/WiXSL))
...
* [Doc] Fix `useNotify` examples ecourage a deprecated syntax ([#6912](https://github.com/marmelab/react-admin/pull/6912)) ([WiXSL](https://github.com/WiXSL))
