...
In any case, it's a good idea to have your component support [translation keys](./Translation.md#translation-keys) in `label`, and hiding labels when `label={false}`.
