...
Check the [Translating the UI](../i18n/TranslationTranslating.md) for example usage of the `useTranslate` hook. 
...
Check [the translation setup documentation](../i18n/TranslationSetup.md) for details about `ra-i18n-polyglot` and how to configure it.
...
Check [the translation setup documentation](../i18n/TranslationSetup.md) to understand how to build your own translation file, the [list of available translations](../i18n/TranslationLocales.md) to find a translation for your language, and  [Translating the UI](../i18n/TranslationTranslating.md) to understand how to translate ra-core components.
