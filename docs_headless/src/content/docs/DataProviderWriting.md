...
| Method             | Components |
| ------------------ | --------- |
| `getList`          | [`<ListBase>`](./ListBase.md), `<ReferenceInputBase>`, `<ReferenceArrayInputBase>` |
| `getOne`           | [`<ShowBase>`](./ShowBase.md), [`<EditBase>`](./EditBase.md) |
| `getMany`          | [`<ReferenceFieldBase>`](./ReferenceFieldBase.md), [`<ReferenceArrayFieldBase>`](./ReferenceArrayFieldBase.md),`<ReferenceInputBase>`, `<ReferenceArrayInputBase>` |
| `getManyReference` | [`<ReferenceManyFieldBase>`](./ReferenceManyFieldBase.md), [`<ReferenceOneFieldBase>`](./ReferenceOneFieldBase.md) |
| `create`           | [`<CreateBase>`](./CreateBase.md) |
| `update`           | [`<EditBase>`](./EditBase.md) |
