        ...
        <Table>
          ...
          <TableBody>
                  ...
                  <TableRow key={item.product.id}>
                    <TableCell>
                      <Link to={`/Product/${item.product.id}`}>
                        {products[item.product.id].reference}
                      </Link>
                    </TableCell>
                    <TableCell className={classes.rightAlignedCell}>
                      {products[item.product.id].price.toLocaleString(
                        undefined,
                        {
                          style: "currency",
                          currency: "USD"
                    ...
                    <TableCell className={classes.rightAlignedCell}>
                      {(
                        products[item.product.id].price * item.quantity
            ...
            <TableRow>
              <TableCell colSpan={2} />
              <TableCell>
                {translate("resources.Command.fields.basket.sum")}
              </TableCell>
              <TableCell className={classes.rightAlignedCell}>
            ...
            <TableRow>
              <TableCell colSpan={2} />
              <TableCell>
                {translate("resources.Command.fields.basket.delivery")}
              </TableCell>
              <TableCell className={classes.rightAlignedCell}>
            ...
            <TableRow>
              <TableCell colSpan={2} />
              <TableCell>
                {translate("resources.Command.fields.basket.tax_rate")}
              </TableCell>
              <TableCell className={classes.rightAlignedCell}>
