...
const allPermissionsForResource = (resource: string) => [
...
const defaultPermissions = [
    ...allPermissionsForResource('posts'),
    ...allPermissionsForResource('comments'),
    ...allPermissionsForResource('tags'),
];

const usersPermissions = allPermissionsForResource('users');

const permissionsByRole = {
    user: [...usersPermissions],
    admin: [
        ...usersPermissions,
        { action: 'edit', resource: 'posts.authors' },
        { action: 'show', resource: 'posts.authors' },
        { action: 'edit', resource: 'users.role' },
        { action: 'show', resource: 'users.role' },
        { action: 'show', resource: 'users.id' },
        { action: 'save_and_add', resource: 'users' },
        { action: 'edit_by_default', resource: 'users' },
    ],
};
