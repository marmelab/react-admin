...
describe('<RadioButtonGroupInput />', () => {
  ...
  it('should render choices as mui FormControlLabel components with a Radio control', () => {
    ...
    const RadioButtonElements = wrapper.find('WithStyles(FormControlLabel)');
  ...
  it('should displayed helperText if prop is present in meta', () => {
    ...
    const FormHelperTextElement = wrapper.find('WithStyles(FormHelperText)');
    assert.equal(FormHelperTextElement.length, 1);
    assert.equal(FormHelperTextElement.children().text(), 'Can i help you?');
  });
  ...
  describe('error message', () => {
    ...
    it('should be displayed if field has been touched and is invalid', () => {
      ...
      const FormHelperTextElement = wrapper.find('WithStyles(FormHelperText)');
      assert.equal(FormHelperTextElement.length, 1);
      assert.equal(FormHelperTextElement.children().text(), 'Required field.');
    });
