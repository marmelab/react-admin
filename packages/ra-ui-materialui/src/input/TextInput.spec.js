...
describe('<TextInput />', () => {
    ...
    it('should use a ResettableTextField when type is text', () => {
        ...
        const TextFieldElement = wrapper.find('translate(WithStyles(ResettableTextField))');
    ...
    it('should call redux-form onBlur handler when blurred', () => {
        ...
        const wrapper = shallow(<TextInput {...defaultProps} input={{ onBlur }} />);

        const TextFieldElement = wrapper.find('translate(WithStyles(ResettableTextField))').first();
    ...
    describe('error message', () => {
        ...
        it('should be displayed if field has been touched and is invalid', () => {
            ...
            const TextFieldElement = wrapper.find('translate(WithStyles(ResettableTextField))');
            assert.equal(TextFieldElement.prop('helperText'), 'Required field.');
        });
    });
});
