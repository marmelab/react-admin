...
describe('<BooleanField />', () => {
    ...
    it('should display tick and truthy text if strictTypeCheck is false and value is truthy', () => {
        const defaultProps = {
        ...
        const { queryByTitle } = render(
            <BooleanField {...defaultProps} strictTypeCheck={false} />
        );
        expect(queryByTitle('ra.boolean.true')).not.toBeNull();
        expect(
            (queryByTitle('ra.boolean.true').firstChild as HTMLElement).dataset
    ...
    it('should display cross and falsy text if strictTypeCheck is false and value is falsy', () => {
        const defaultProps = {
