...
describe('<Responsive>', () => {
  ...
  it('should render the small component on all screens when no other component is passed', () => {
    assert.equal(
      shallow(<Responsive small={<Small />} width="xs" />).find('Small').length,
      1
    );
    assert.equal(
      shallow(<Responsive small={<Small />} width="sm" />).find('Small').length,
      1
    );
    assert.equal(
      shallow(<Responsive small={<Small />} width="lg" />).find('Small').length,
      1
    );
  });
  it('should render the medium component on all screens when no other component is passed', () => {
    assert.equal(
      shallow(<Responsive medium={<Medium />} width="xs" />).find('Medium')
        .length,
      1
    );
    assert.equal(
      shallow(<Responsive medium={<Medium />} width="sm" />).find('Medium')
        .length,
      1
    );
    assert.equal(
      shallow(<Responsive medium={<Medium />} width="lg" />).find('Medium')
        .length,
      1
    );
  });
  it('should render the large component on all screens when no other component is passed', () => {
    assert.equal(
      shallow(<Responsive large={<Large />} width="xs" />).find('Large').length,
      1
    );
    assert.equal(
      shallow(<Responsive large={<Large />} width="sm" />).find('Large').length,
      1
    );
    assert.equal(
      shallow(<Responsive large={<Large />} width="lg" />).find('Large').length,
      1
    );
  });
