...
describe('<TabbedForm />', () => {
    it('should render tabs', () => {
        ...
        const tabsContainer = wrapper.dive().find('WithStyles(Tabs)');
        assert.equal(tabsContainer.length, 1);
        const tabs = wrapper.dive().find('FormTab');
    ...
    it('should display <Toolbar />', () => {
        ...
        const toolbar = wrapper.dive().find('WithStyles(Toolbar)');
    ...
    it('should pass submitOnEnter to <Toolbar />', () => {
        ...
        const button1 = wrapper1.dive().find('WithStyles(Toolbar)');
        ...
        const button2 = wrapper2.dive().find('WithStyles(Toolbar)');
    ...
    it('should set the style of an inactive Tab button with errors', () => {
        ...
        const tabs = wrapper.dive().find('WithStyles(Tab)');
