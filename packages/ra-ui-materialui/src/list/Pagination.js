      ...
      (pageNum, index) =>
        pageNum === '.' ? (
          ...
          <Button
            ...
            color={pageNum === this.props.page ? 'default' : 'primary'}
            key={pageNum}
            data-page={pageNum}
      ...
      <Responsive
        small={
          ...
          >
            ...
            <Typography variant="body1" className="displayed-records">
        ...
        medium={
          <Toolbar
            className={classnames(className, classes.desktopToolbar)}
            {...rest}
          >
            <Typography variant="body1" className="displayed-records">
              {translate('ra.navigation.page_range_info', {
