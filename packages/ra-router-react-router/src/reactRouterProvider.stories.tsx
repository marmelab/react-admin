...
import { createHashRouter, Link as ReactRouterLink } from 'react-router-dom';
import {
    useNavigate,
    useLocation,
    LinkBase,
...
/**
 * Basic: Admin creates its own React Router (standalone mode)
...
const { Routes, Outlet: RouterOutlet } = reactRouterProvider;
...
export const PathlessLayoutRoutes = () => {
    const { RouterWrapper } = reactRouterProvider;

    return (
        <RouterProviderContext.Provider value={reactRouterProvider}>
            <RouterWrapper>
                <Routes>
                    <Route
                        element={
