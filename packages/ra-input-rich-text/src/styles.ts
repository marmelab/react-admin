    ...
    '@global': {
        ...
        '.ra-rich-text-input': {
            '& .ql-editor': {
                ...
                padding: '6px 12px',
                backgroundColor: theme.palette.type === 'dark' ? 'rgba(255, 255, 255, 0.04)' : 'rgba(0, 0, 0, 0.04)',
                '&:hover::before': {
                    backgroundColor: theme.palette.type === 'dark' ? 'rgba(255, 255, 255, 1)' : 'rgba(0, 0, 0, 1)',
                    height: 2,
                },
                ...
                '&::before': {
                    ...
                    backgroundColor: theme.palette.type === 'dark' ? 'rgba(255, 255, 255, 0.7)' : 'rgba(0, 0, 0, 0.5)', 
                },
