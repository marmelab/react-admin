...
/**
 * BasicStandalone: Admin creates its own React Router (standalone mode)
...
// A single splat route under /admin handles /admin, /admin/posts,
// /admin/posts/1/show, etc. (react-router resolves nested paths from one route).
