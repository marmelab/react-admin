...
export const selectViewVersion = (state: UIState) => state.viewVersion;
export const selectIsSidebarOpen = (state: UIState) => state.sidebarOpen;
export const selectIsOptimistic = (state: UIState) => state.optimistic;
