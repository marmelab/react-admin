...
describe('RecordRepresentation', () => {
    ...
    it('should render the record id when provided as a field name on its parent <Resource>', async () => {
        render(<StringRecordRepresentation />);
        await screen.findByText("The Hitchhiker's Guide to the Galaxy");
    });
    it('should render the record id when provided as a function on its parent <Resource>', async () => {
        render(<FunctionRecordRepresentation />);
        await screen.findByText(
            "The Hitchhiker's Guide to the Galaxy by Douglas Adams"
        );
    });
    it('should render the record id when provided as a component on its parent <Resource>', async () => {
