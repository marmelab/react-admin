...
* 👨‍👩‍👧‍👦 Powered by [Material UI](https://mui.com/material-ui/getting-started/), [react-hook-form](https://react-hook-form.com), [react-router](https://reacttraining.com/react-router/), [react-query]([https://react-query-v3.tanstack.com/](https://tanstack.com/query/latest/docs/framework/react/overview)), [TypeScript](https://www.typescriptlang.org/) and a few more
