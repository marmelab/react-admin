...
describe('<AddressField />', () => {
  ...
  it('should render Google maps link for desktop users', () => {
    ...
    const wrapper = shallow(<AddressField record={record} source="address" />);
    assert.equal(wrapper.html(), '<a target="_blank" href="https://www.google.com/maps/search/?api=1&amp;query=5 Avenue Anatole France, 75007 Paris"><span>5 Avenue Anatole France, 75007 Paris</span></a>');
  });
});
