...
For advanced users who wish to use the customized `<AppBar>` from MUI package or place `<LocalesMenuButton>` elsewhere on the a custom configuration page, they can do the following:
