...
* **[GraphQL](http://graphql.org/)**: [marmelab/ra-graphql-client](https://github.com/marmelab/react-admin/packages/ra-graphql-client) (uses [Apollo](http://www.apollodata.com/))
* **[GraphCool](http://www.graph.cool/)**: [marmelab/ra-graphql-client-graphcool](https://github.com/marmelab/react-admin/packages/ra-graphql-client) (uses [Apollo](http://www.apollodata.com/))
