...
To enable users to search for data in the table, you can add the `<SearchInput>` component to the `filters` array of your `<List>` as explained in [the component chapter](./SearchInput.md).
