...
* ![duckdb Logo](./img/backend-logos/duckdb.svg "duckdb Logo")**[DuckDB](https://duckdb.org/)**: [codeledge/ra-tools](https://github.com/codeledge/ra-tools/tree/main/packages/ra-data-duckdb)
