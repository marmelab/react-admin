...
**Note**  `<CloneButton>` is designed to be used in an edit view _Actions_ component, not inside a _Toolbar_. The Toolbar is basically for submitting the form, not for going to another resource.
